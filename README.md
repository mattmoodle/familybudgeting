...
- pagina **Transazioni** con ricerca per testo, filtri su importo e stato, paginazione da 20/50/100 righe e azioni multiple sulle righe selezionate (categoria, inclusione nelle analisi e segnalazione sospetta); dopo ogni modifica riuscita l'elenco viene richiesto nuovamente al server conservando filtri e pagina applicati;
...
- pagina **Documenti importati** con file, conto, intervallo della prima/ultima transazione, data/ora di caricamento, modalità, stato e accesso alle revisioni Human-check aperte; filtri locali e intestazioni ordinabili permettono di esplorare facilmente l'archivio;
